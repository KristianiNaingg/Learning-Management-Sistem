...
@section('content')
    <div class="container mt-4">
        <h2>Tambah File untuk {{ $selectedSubtopic->title }}</h2>
        @if(session('success'))
        ...
        @endif
        <form method="POST" action="{{ route('lom_files.store') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    @if($folders->isNotEmpty())
                        <div class="mb-3">
                            <label for="folders" class="form-label">Pilih Folder (Opsional)</label>
                    ...
                    @else
                        <div class="alert alert-warning">Tidak ada folder tersedia.</div>
                    @endif
                </div>
            </div>
