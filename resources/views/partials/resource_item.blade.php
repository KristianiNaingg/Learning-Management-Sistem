<div class="list-group-item list-group-item-action border-0 rounded shadow-sm mb-2 ps-5">
    ...
    @elseif ($item instanceof App\Models\LomFile && $item->folders->isEmpty())
    <div class="d-flex justify-content-between align-items-center">
        <a href="{{ Storage::url('files/' . basename($item->file_path)) }}" target="_blank" class="text-decoration-none d-flex align-items-center">
            <i class="fas me-3 fs-4
    ...
    @elseif ($item instanceof App\Models\LomInfographic)
    <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
            <i class="fas me-3 fs-4
            ...
            <div>
                ...
                <div class="mt-2">
                    <img src="{{ Storage::url('infographics/' . basename($item->file_path)) }}"
    ...
    <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-start">
            ...
            <div>
                <h6 class="mb-1">{!! $item->name !!}</h6>
                <p class="mb-0 text-muted">{!! $item->description !!}</p>
                <a href="{{ $item->url_link }}" target="_blank" class="d-block text-truncate text-muted">
                    {!! $item->url_link !!}
                </a>
            </div>
        </div>
    ...
    @elseif ($item instanceof App\Models\LomQuiz)
    <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-start">
