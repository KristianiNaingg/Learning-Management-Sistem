                ...
                <div class="col-md-12">
                    <div class="card shadow-sm border-0 rounded-lg">
                        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center py-3">
                            <h2 class="mb-0 font-weight-bold" style="font-family: 'Poppins', sans-serif;">Duplikasi Label {{ $subTopic->title }}</h2>
                        </div>
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('labels.storeDuplicate', $label->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                                @csrf
                                <input type="hidden" name="sub_topic_id" value="{{ $subTopic->id }}">
                                <input type="hidden" name="original_label_id" value="{{ $label->id }}">

                                <div class="row g-4">
                                    <div class="col-12">
                                        <label for="konten" class="form-label font-weight-medium" style="font-family: 'Poppins', sans-serif; color: #3F4254;">Teks Label</label>
                                        <textarea name="konten" id="konten" rows="4" class="form-control rounded" style="border-color: #E4E6EF;" required>{{ old('konten', $label->konten . ' (Salinan)') }}</textarea>
                                        <div class="invalid-feedback" style="font-family: 'Poppins', sans-serif;">Konten wajib diisi dan harus berbeda dari label asli.</div>
                                        @error('konten')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div id="dimension-container">
                                            @php
                                                ...
                                                $selectedOptionId = old('dimension_options', $label->options->pluck('id')->first());
                                            @endphp
