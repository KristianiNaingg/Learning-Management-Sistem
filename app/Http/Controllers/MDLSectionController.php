    ...
    public function duplicate($type, $id)
{
    try {
        // Map type to model
        $modelMap = [
            'label' => \App\Models\MDLLabel::class,
            'files' => \App\Models\MDLFiles::class,
            'infografis' => \App\Models\MDLInfografis::class,
            'assign' => \App\Models\MDLAssign::class,
            'forum' => \App\Models\MDLForum::class,
            'lesson' => \App\Models\MDLLesson::class,
            'url' => \App\Models\MDLUrl::class,
            'folder' => \App\Models\MDLFolder::class,
            'page' => \App\Models\MDLPage::class,
        ];
        ...
        $newItem->name = $newItem->name . ' (Copy)'; // Append " (Copy)" to name
        $newItem->save();
