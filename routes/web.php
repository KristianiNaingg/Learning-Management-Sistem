...
Route::middleware(['auth', 'role:2'])->group(function () {
    ...
    Route::get('/assignments/{id}/duplicate', [MDLAssignController::class, 'duplicate'])->name('assignments.duplicate');
    Route::post('/assignments/{id}/duplicate', [MDLAssignController::class, 'storeDuplicate'])->name('assignments.storeDuplicate');
    ...
    Route::get('/forums/{id}/duplicate', [MDLForumController::class, 'duplicate'])->name('forums.duplicate');
    Route::post('/forums/{id}/duplicate', [MDLForumController::class, 'storeDuplicate'])->name('forums.storeDuplicate');
    ...
    Route::get('files/{id}/duplicate', [MDLFileController::class, 'duplicate'])->name('files.duplicate');
    Route::post('/files/{id}/duplicate', [MDLFileController::class, 'storeDuplicate'])->name('files.storeDuplicate');
    ...
    Route::delete('/folders/{id}', [MDLFolderController::class, 'destroy'])->name('folders.destroy');
      ...
      Route::get('folders/{id}/duplicate', [MDLFolderController::class, 'duplicate'])->name('folders.duplicate');
    Route::post('/folders/{id}/duplicate', [MDLFolderController::class, 'storeDuplicate'])->name('folders.storeDuplicate');
    ...
    Route::get('/infografis/{id}/duplicate', [MDLInfografisController::class, 'duplicate'])->name('infografis.duplicate');
    Route::post('/infografis/{id}/duplicate', [MDLInfografisController::class, 'storeDuplicate'])->name('infografis.storeDuplicate');
    ...
    Route::delete('/pages/{id}', [MDLPageController::class, 'destroy'])->name('pages.destroy');
      Route::get('/pages/{id}/duplicate', [MDLPageController::class, 'duplicate'])->name('pages.duplicate');
    Route::post('/pages/{id}/duplicate', [MDLPageController::class, 'storeDuplicate'])->name('pages.storeDuplicate');
    ...
    Route::get('labels/{id}/duplicate', [MDLLabelController::class, 'duplicate'])->name('labels.duplicate');
    Route::post('/labels/{id}/duplicate', [MDLLabelController::class, 'storeDuplicate'])->name('labels.storeDuplicate');

    Route::get('/urls/create', [MDLUrlController::class, 'create'])->name('urls.create');
    Route::post('/urls/store', [MDLUrlController::class, 'store'])->name('urls.store');
    Route::get('/urls/{id}/edit', [MDLUrlController::class, 'edit'])->name('urls.edit');
    Route::put('/urls/{id}', [MDLUrlController::class, 'update'])->name('urls.update');
    Route::delete('/urls/{id}', [MDLUrlController::class, 'destroy'])->name('urls.destroy');
    Route::get('/urls/{id}/duplicate', [MDLUrlController::class, 'duplicate'])->name('urls.duplicate');
    Route::post('/urls/{id}/duplicate', [MDLUrlController::class, 'storeDuplicate'])->name('urls.storeDuplicate');
    ...
    Route::get('lessons/{id}/duplicate', [MDLLessonController::class, 'duplicate'])->name('lessons.duplicate');
    Route::post('/lessons/{id}/duplicate', [MDLLessonController::class, 'storeDuplicate'])->name('lessons.storeDuplicate');
